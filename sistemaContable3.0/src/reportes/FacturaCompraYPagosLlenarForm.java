...
public class FacturaCompraYPagosLlenarForm implements JRDataSource {
	...
	public void recibirDatosExternos(String numero) {
		...
		try {
			...
			reporte = (JasperReport) JRLoader
					.loadObject("bin/reportesnuevos/reportePagosPorCompra.jasper");
			JasperPrint jasperPrint = JasperFillManager.fillReport(reporte,
					parameterMap, conn.getConexion());//
			JasperViewer jviewer = new JasperViewer(jasperPrint, false);
			jviewer.setTitle("Reporte de Factura de compra y Pagos realizados");
