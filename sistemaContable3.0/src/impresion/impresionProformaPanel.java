...
public class impresionProformaPanel extends JPanel {
	...
	public void grabarCambios(String arr[]) {
		try {
			...
			setContents(new File("bin/ConfigImpresion/proformaparam.txt"), arr);
	...
	private void cargarDatos() {
		String arr[] = getContents(new File(
				"bin/ConfigImpresion/proformaparam.txt"));
	...
	private void imprimir() {
		impresionProformaParametros pj = new impresionProformaParametros();
