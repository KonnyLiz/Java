...
public class modeloDeudasPorCliente implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		PagoDeReciboPorClienteTemp aux;
	 ...
	 */
	public void nuevoItem(PagoDeReciboPorClienteTemp item) {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		case 2:
			...
			break;
		case 3:
			aux.setCantidad((String) aValue);
			break;
		case 4:
			aux.setDetalle((String) aValue);
			break;
		case 5:
			aux.setPlazo((String) aValue);
			break;
		default:
			break;
		}
	 ...
	 */
	public void nuevoItemEnPosicion(PagoDeReciboPorClienteTemp nuevoItem, int posicion) {
		// Añade el item al modelo
	 ...
	 */
	private LinkedList<PagoDeReciboPorClienteTemp> datos = new LinkedList<PagoDeReciboPorClienteTemp>();
