...
public class modeloAlertas implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			return aux.getAlerta();
		case 1:
			return aux.getDescripcion();
		case 2:
			return "" + aux.getFechaInicio();
		case 3:
			return aux.getFechaFinalizacionAlerta();
		case 4:
			return "" + aux.getEstado();
		case 5:
			return "" + aux.getDescripcion2();
		case 6:
			return aux.getModificar();
		case 7:
	 ...
	 */
	public void nuevoItem(alertaTablaObj item) {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			aux.setAlerta((String) aValue);
			break;
		case 1:
			aux.setDescripcion((String) aValue);
			break;
		case 2:
			aux.setFechaInicio(((String) aValue).toString());
			break;
		case 3:
		...
		case 4:
			...
			break;
		case 5:
			aux.setDescripcion2((String) aValue);
			break;
		case 6:
			aux.setModificar((Boolean) aValue);
			break;
		case 7:
	 ...
	 */
	public void nuevoItemEnPosicion(alertaTablaObj nuevoItem, int posicion) {
		// Añade el item al modelo
	 ...
	 */
	private LinkedList<alertaTablaObj> datos = new LinkedList<alertaTablaObj>();
