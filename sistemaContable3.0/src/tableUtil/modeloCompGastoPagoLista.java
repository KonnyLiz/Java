...
public class modeloCompGastoPagoLista implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		consultaComGastosPagoLista aux;
		...
		case 1:
			return aux.getNumComprobante();
		case 2:
			return aux.getDescripcion();
		case 3:
			return aux.getTipoComprobante();
		case 4:
			return aux.getTotal();
		case 5:
			return aux.getDescripcionAdicional();
		case 6:
			return aux.getFecha();
		case 7:
	 ...
	 */
	public void nuevoItem(consultaComGastosPagoLista itemClase) {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		case 0:
			...
			break;
		case 1:
			aux.setNumComprobante((String) aValue);
			break;
		case 2:
			aux.setDescripcion((String) aValue);
			break;
		case 3:
			aux.setTipoComprobante((String) aValue);
			break;
		case 4:
			aux.setTotal((String) aValue);
			break;
		case 5:
			aux.setDescripcionAdicional((String) aValue);
			break;
		case 6:
	 ...
	 */
	public void nuevoItemEnPosicion(consultaComGastosPagoLista nuevoItem, int posicion) {
		// Añade el item al modelo
	 ...
	 */
	private LinkedList<consultaComGastosPagoLista> datos = new LinkedList<consultaComGastosPagoLista>();
