/**
 * Solo para useo de inventarioVentana.java
 */
...
public class modeloInventario implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 2:
			return "" + aux.getFechaCaducidad();
		case 3:
			return aux.getPrecioCompra();
		case 4:
	 ...
	 */
	public void nuevoItem(detalleInventario item) {
	...
	public Class getColumnClass(int columnIndex) {
		...
		case 0:
			...
			return Float.class;
		case 1:
			// contiene Fecha Ingreso
			// un String
			return String.class;
		case 2:
			// contiene Fecha Caducidad
			// String
			return String.class;
		case 3:
			// contiene el precio costo
			// String
			return Float.class;
		case 4:
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			aux.setCantidad((Float) aValue);
			break;
		case 1:
			aux.setFechaIngreso((String) aValue);
			break;
		case 2:
			aux.setFechaCaducidad(((String) aValue).toString());
			break;
		case 3:
			aux.setPrecioCompra((Float) aValue);
			break;
		case 4:
	 ...
	 */
	private LinkedList<detalleInventario> datos = new LinkedList<detalleInventario>();
