...
/**
 * Solo para uso de comprasGastosVentana.java
 */
...
public class ModeloProveedor implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		ArregloProveedorTemp aux;

		// Se obtiene el item de la fila indicada
		aux = (ArregloProveedorTemp) (datos.get(rowIndex));
	 ...
	 */
	public void nuevoItem(ArregloProveedorTemp item) {
...
// && columnIndex != 3
	 ...
	 */
	public void nuevoItemEnPosicion(ArregloProveedorTemp nuevoItem, int posicion) {
		// Añade el item al modelo
