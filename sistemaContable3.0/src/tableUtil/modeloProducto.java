/**
 * Solo para uso de ListainventarioVentana.java
 */
package tableUtil;
...
public class modeloProducto implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		detalleProductosInventario aux;
		...
		switch (columnIndex) {
		case 0:
			return "" + aux.getTipoProducto();
		case 1:
			return "" + aux.getProducto();
		case 2:
			return "" + aux.getNomenclatura();
		case 3:
			return "" + aux.getBodega();
		case 4:
			return aux.getPrecioVenta();
		case 5:
			return aux.getActualizar();
		default:
			return null;
		}
	}
	 ...
	 */
	public void nuevoItem(detalleProductosInventario itemClase) {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			aux.setTipoProducto((String) aValue);
			break;
		case 1:
			aux.setProducto((String) aValue);
			break;
		case 2:
			aux.setNomenclatura(((String) aValue).toString());
			break;
		case 3:
			aux.setBodega((String) aValue);
			break;
		case 4:
			aux.setPrecioVenta((String) aValue);
			break;
		case 5:
			aux.setActualizar((Boolean) aValue);
			break;
	 ...
	 */
	public void nuevoItemEnPosicion(detalleProductosInventario nuevoItem,
			int posicion) {
		// Añade el item al modelo
	 ...
	 */
	private LinkedList<detalleProductosInventario> datos = new LinkedList<detalleProductosInventario>();
