...
public class modeloRecibo implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 2:
			return aux.getVUnitario();
		case 3:
			return aux.getVTotal();
		case 4:
	 ...
	 * Añade una item al final de la tabla
	 */
	public void nuevoItem(detalleRecibo nuevoItem) {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		case 1:
			...
			break;
		case 2:
			aux.setVUnitario((Float) aValue);
			break;
		case 3:
			aux.setVTotal((Float) aValue);
			break;
		case 4:
	 ...
	 */
	public void nuevoItemEnPosicion(detalleRecibo item, int posicion) {
		// Añade el item al modelo
		datos.add(posicion, item);
	 ...
	 */
	private LinkedList<detalleRecibo> datos = new LinkedList<detalleRecibo>();
