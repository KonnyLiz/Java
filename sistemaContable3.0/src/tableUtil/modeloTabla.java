...
public class modeloTabla implements TableModel {
	 ...
	 */
	public void nuevoItem(detalleOdtRecibo item) {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		case 1:
			...
			break;
		case 2:
			aux.setMedidaX(((String) aValue).toString());
			break;
		case 3:
			aux.setPrecio((Float) aValue);
			break;
		case 4:
			aux.setPrecioUnidad((Float) aValue);
			break;
		case 5:
	 ...
	 */
	public void nuevoItemEnPosicion(detalleOdtRecibo nuevoItem, int posicion) {
		// Añade el item al modelo
	 ...
	 */
	private LinkedList<detalleOdtRecibo> datos = new LinkedList<detalleOdtRecibo>();
