...
public class modeloOdtLista implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 5:
			return aux.getSaldo();
		case 6:
			return aux.getFacturar();
		case 7:
			return aux.getEntregar();
		case 8:
	 ...
	 */
	public void nuevoItem(detalleOdtLista nuevoItem) {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		case 1:
			...
			break;
		case 2:
			aux.setNumero((String) aValue);
			break;
		case 3:
			aux.setTotal(((Float) aValue));
			break;
		case 4:
			aux.setAbono((Float) aValue);
			break;
		case 5:
			aux.setSaldo((Float) aValue);
			break;
		case 6:
			aux.setEntregar((Boolean) aValue);
			break;
		case 7:
			aux.setFacturar((Boolean) aValue);
			break;
		case 8:
			aux.setEliminar((Boolean) aValue);
			break;
		case 9:
			aux.setId_ot((String) aValue);
			break;
		default:
			break;
		}
	 ...
	 */
	public void nuevoItemEnPosicion(detalleOdtLista nuevoItem, int posicion) {
		// Añade el item al modelo
	 ...
	 */
	private LinkedList<detalleOdtLista> datos = new LinkedList<detalleOdtLista>();
