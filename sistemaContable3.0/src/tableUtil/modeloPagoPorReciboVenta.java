...
public class modeloPagoPorReciboVenta implements TableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			return aux.getIdTipoPagoReciboPK();
		case 1:
			return aux.getTipoPagoString();
		case 2:
	 ...
	 */
	public void nuevoItem(tipoPagoRecibo nuevoItem) {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			aux.setIdTipoPagoReciboPK((Integer) aValue);
			break;
		case 1:
			aux.setTipoPagoString((String) aValue);
			break;
		case 2:
	 ...
	 */
	private LinkedList<tipoPagoRecibo> datos = new LinkedList<tipoPagoRecibo>();
