...
public class listaEmpVentana extends JInternalFrame {
	/**
	 ...
	 * 
	 */
	Object[] etiquetasColumna = { "RUC CLIENTE ", "NOMBRE COMPLETO",
			"FECHA DE NACIMIENTO", "FECHA DE INGRESO", "ROL DEL USUARIO",
	...
	private void initialize() {
		...
		this.setTitle("Administracion -> Lista de Empleados ");
		...
		cols = 10;
		Object temporal[][] = empleadoMd.seleccionarTodos(conexion
				.getConexion());
