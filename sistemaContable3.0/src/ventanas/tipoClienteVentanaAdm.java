...
public class tipoClienteVentanaAdm extends JInternalFrame {
	...
	private tipoCliente tcDp = new tipoCliente(0, ""); // @jve:decl-index=0:
	private tipoClienteBdd tpMd = new tipoClienteBdd();
	/**
	...
	private void initialize() {
		...
		this.setTitle("Administración Tipos de Clientes");
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			Administracióndeclientes
					.setText("Administración de Tipos de Clientes");
			Administracióndeclientes
	...
	private JPanel getJPanelEtiquetas() {
		if (jPanelEtiquetas == null) {
			...
			jLabelDescripcion.setText("ID Tipo de Cliente :");
					...
					.addFocusListener(new java.awt.event.FocusAdapter() {
						...
						public void focusLost(java.awt.event.FocusEvent e) {
							if (jTextFieldDescripcion.getText().trim()
								...
								tcDp.setDescripcion(jTextFieldDescripcion
										.getText().trim());
								buscarItem();
							}// end else
						}
		...
		if (choiceExistentes == null) {
			...
			choiceExistentes.addItemListener(new java.awt.event.ItemListener() {
				public void itemStateChanged(java.awt.event.ItemEvent e) {
					...
					tcDp.setDescripcion(choiceExistentes.getSelectedItem());
					opcionModulo = 2;
					buscarItem();
	...
	private void buscarItem() {
		...
		if (tcDp.getIdTc() == 0) {
			...
			jTextFieldId.setEnabled(false);
			choiceExistentes.setEnabled(false);
			jTextFieldId.setText("" + tcDp.getIdTc());
			jTextFieldDescripcion.setText(tcDp.getDescripcion());
			jButtonIngresar.setEnabled(false);
	...
	private void insertar() {
		if (opcionModulo == 1
			...
			tpMd.insertar(con.getConexion(), tcDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
	...
	private void modificar() {
		if (opcionModulo == 2
				&& jTextFieldDescripcion.getText().compareTo("") != 0) {
			tpMd.modificar(con.getConexion(), tcDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
					"El campo Descripción Está Vacio! ", "Aviso!",
	...
	private void eliminar() {
		if (opcionModulo == 2
				&& jTextFieldDescripcion.getText().compareTo("") != 0) {
			tpMd.eliminar(con.getConexion(), tcDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
					"El campo Descripción Está Vacio! ", "Aviso!",
