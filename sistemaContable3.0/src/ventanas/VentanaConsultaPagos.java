...
import reportes.FacturaCompraLlenarForm;
import tableUtil.modeloPagosLista;
...
public class VentanaConsultaPagos extends JInternalFrame {

	private static final long serialVersionUID = 1L;
	private JPanel jContentPane = null;
	private JButton jButtonCalendario = null;
	private modeloPagosLista modelo = null; // @jve:decl-index=0:
	...
	public VentanaConsultaPagos(String User, JDesktopPane desktopPane2) {
	...
	private void initialize() {
		...
		this.setTitle("Consulta de Recibos  de compra y gastos realizados");
	 ...
	 */
	private modeloPagosLista getModelo() {
		if (modelo == null) {
			modelo = new modeloPagosLista();
		}
		return modelo;
	}
	...
	private void cargarDatos(Object[][] items) {
		for (int i = 0; i < items.length; i++) {
			if (items[i][0] != null) {
				...
				consultaPagosTabla itemClase = new consultaPagosTabla(""
	...
	private void verReporte(String numero) {
		FacturaCompraLlenarForm reporteJasper = new FacturaCompraLlenarForm();
	...
	private void cargarDatosFecha() {
		...
		Object items[][] = pagoPorGastosmD.seleccionarOdtEncabezadosFechas(conn
	...
	private void cargarDatosNombre() {
		...
		Object items[][] = pagoPorGastosmD
				.seleccionarOdtEncabezadosBeneficiario(conn.getConexion(),
