...
public class unidadMedidaVentana extends JInternalFrame {
	...
	private void initialize() {
		...
		this.setTitle("Administración Tipos de Unidad de Medida");
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			Administracióndeclientes
					.setText("Administración de Tipos de Unidad De Medida");
			Administracióndeclientes
	...
	private JTextField getJTextFieldDescripcion() {
		if (jTextFieldDescripcion == null) {
			...
			jTextFieldDescripcion
					.setToolTipText("Modifica la Descripción de la Unidad de Medida");
			jTextFieldDescripcion
	...
	private JTextField getJTextFieldNomenclatura() {
		if (jTextFieldNomenclatura == null) {
			...
			jTextFieldNomenclatura
					.setToolTipText("Modifica la Nomenclatura de unidad de Médida");
			jTextFieldNomenclatura
					.addFocusListener(new java.awt.event.FocusAdapter() {
						@Override
						public void focusLost(java.awt.event.FocusEvent e) {
