...
public class listaClientesVentana extends JInternalFrame {
	 ...
	 */
	public listaClientesVentana(JDesktopPane JDesktopPanePrin1) {
	...
	private void initialize() {
		...
		this.setTitle("Administrar ->  Lista de Clientes");
	}
				...
				public void mouseClicked(java.awt.event.MouseEvent e) {
					...
					if (modelo.getRowCount() > 0) {
						String dato = modelo.getValueAt(rowTemp, 0).toString()
								.trim();
						if (columnTemp == 4
								&& dato.compareToIgnoreCase("no hay registros") != 0) {
							...
							JDesktopPanePrin.add(ClienteVentana);
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new Rectangle(31, 120, 585, 311));
