...
public class rolVentanaAdm extends JInternalFrame {
	...
	private void initialize() {
		...
		this.setTitle("Administración Tipos de Rol");
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			Administracióndeclientes
					.setText("Administración de Tipos de rol para Usuarios");
			Administracióndeclientes
	...
	private JPanel getJPanelEtiquetas() {
		if (jPanelEtiquetas == null) {
			...
			jLabelDescripcion.setText("ID de Rol:");
					...
					.addFocusListener(new java.awt.event.FocusAdapter() {
						...
						public void focusLost(java.awt.event.FocusEvent e) {
							if (jTextFieldDescripcion.getText().trim()
								...
								rolDp.setDescripcion(jTextFieldDescripcion
										.getText().trim());
								buscarItem();
							}// end else
						}
			...
			jTextFieldDescripcion
					.addKeyListener(new java.awt.event.KeyAdapter() {
						...
						public void keyTyped(java.awt.event.KeyEvent e) {
							System.out.println("keyTyped()"); // TODO
							// Auto-generated
							// Event stub
							// keyTyped()
						}
		...
		if (choiceExistentes == null) {
			...
			choiceExistentes.addItemListener(new java.awt.event.ItemListener() {
				public void itemStateChanged(java.awt.event.ItemEvent e) {
					...
					rolDp.setDescripcion(choiceExistentes.getSelectedItem());
					opcionModulo = 2;
					buscarItem();
	...
	private void buscarItem() {
		...
		if (rolDp.getId() == 0) {
			...
			jTextFieldId.setEnabled(false);
			choiceExistentes.setEnabled(false);
			jTextFieldId.setText("" + rolDp.getId());
			jTextFieldDescripcion.setText(rolDp.getDescripcion());
			jButtonIngresar.setEnabled(false);
	...
	private void insertar() {
		if (opcionModulo == 1
			...
			rolMd.insertar(con.getConexion(), rolDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
	...
	private void modificar() {
		if (opcionModulo == 2
				&& jTextFieldDescripcion.getText().compareTo("") != 0) {
			rolMd.modificar(con.getConexion(), rolDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
					"El campo Descripción Está Vacio! ", "Aviso!",
	...
	private void eliminar() {
		if (opcionModulo == 2
				&& jTextFieldDescripcion.getText().compareTo("") != 0) {
			rolMd.eliminar(con.getConexion(), rolDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
					"El campo Descripción Está Vacio! ", "Aviso!",
