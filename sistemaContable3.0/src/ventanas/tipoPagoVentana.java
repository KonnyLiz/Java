...
public class tipoPagoVentana extends JInternalFrame {
	...
	private tipoPago tpDp = new tipoPago(0, ""); // @jve:decl-index=0:
	private tipoPagoBdd tpMd = new tipoPagoBdd();
	/**
	...
	private void initialize() {
		...
		this.setTitle("Administración Tipos de Tipo de Pago");
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			Administracióndeclientes.setText("Administración de Tipos de Pago");
	...
	private JPanel getJPanelEtiquetas() {
		if (jPanelEtiquetas == null) {
			...
			jLabelDescripcion.setText("ID Tipo de Pago :");
	...
	private JTextField getJTextFieldDescripcion() {
		if (jTextFieldDescripcion == null) {
			...
			jTextFieldDescripcion
					.setToolTipText("Modifica la Información del Tipo de Pago");
					...
					.addFocusListener(new java.awt.event.FocusAdapter() {
						...
						public void focusLost(java.awt.event.FocusEvent e) {
							if (jTextFieldDescripcion.getText().trim()
								...
								tpDp.setDescripcionTp(jTextFieldDescripcion
										.getText().trim());
								buscarItem();
							}// end else
						}
		...
		if (choiceExistentes == null) {
			...
			choiceExistentes.addItemListener(new java.awt.event.ItemListener() {
				public void itemStateChanged(java.awt.event.ItemEvent e) {
					...
					tpDp.setDescripcionTp(choiceExistentes.getSelectedItem());
					opcionModulo = 2;
					buscarItem();
	...
	private void buscarItem() {
		...
		tpDp = tpMd.buscarInfoDeUnRegistro(con.getConexion(), tpDp);
		...
		if (tpDp.getIdTp() == 0) {
			...
			jTextFieldId.setEnabled(false);
			choiceExistentes.setEnabled(false);
			jTextFieldId.setText("" + tpDp.getIdTp());
			jTextFieldDescripcion.setText(tpDp.getDescripcionTp());
			jButtonIngresar.setEnabled(false);
	...
	private void insertar() {
		if (opcionModulo == 1
			...
			tpMd.insertar(con.getConexion(), tpDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
	...
	private void modificar() {
		if (opcionModulo == 2
				&& jTextFieldDescripcion.getText().compareTo("") != 0) {
			tpMd.modificar(con.getConexion(), tpDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
					"El campo Descripción Está Vacio! ", "Aviso!",
	...
	private void eliminar() {
		if (opcionModulo == 2
				&& jTextFieldDescripcion.getText().compareTo("") != 0) {
			tpMd.eliminar(con.getConexion(), tpDp);
			cargarChoice();
		} else {
			JOptionPane.showMessageDialog(null,
					"El campo Descripción Está Vacio! ", "Aviso!",
