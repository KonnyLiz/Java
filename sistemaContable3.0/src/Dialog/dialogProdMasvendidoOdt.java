...
public class dialogProdMasvendidoOdt extends JFrame {
	 ...
	 */
	public dialogProdMasvendidoOdt(String fecha1, String fecha2) {
		super();
		initialize();
	...
	public void llenarReporte(HashMap parameterMap, String Query) {
		...
		try {
			...
			reporte = (JasperReport) JRLoader
					.loadObject("bin/reportesnuevos/reporteProductosODTVendidos.jasper");

			JasperPrint jasperPrint = JasperFillManager.fillReport(reporte,
					parameterMap, conn.getConexion());//
			JasperViewer jviewer = new JasperViewer(jasperPrint, false);
			jviewer.setTitle("Reporte Producto Elaborado más vendido ODT");
