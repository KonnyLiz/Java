...
public class dialogMostrarReporteEgresosFechas extends JFrame {
	 ...
	 */
	public dialogMostrarReporteEgresosFechas(String fecha1, String fecha2) {
		super();
		initialize();
	...
	public void llenarReporteEgresos(HashMap parameterMap, String Query) {
		...
		try {
			...
			reporte = (JasperReport) JRLoader
					.loadObject("bin/reportes/reporteDeEgresos.jasper");
			...
			jviewer.setTitle("Reporte de Egresos");
	...
	public void llamarCompraporGastoReporte(String fecha1, String fecha2) {
		String Query = "SELECT "
				...
				+ " FROM `comprobante_egreso`" + " where FECHA BETWEEN '"
				+ fecha1 + "' AND '" + fecha2 + "'";
