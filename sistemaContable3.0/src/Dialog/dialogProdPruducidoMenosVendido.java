...
public class dialogProdPruducidoMenosVendido extends JFrame {
	 ...
	 */
	public dialogProdPruducidoMenosVendido(String fecha1, String fecha2) {
		super();
		initialize();
	...
	public void llenarReporte(HashMap parameterMap, String Query) {
		...
		try {
			...
			reporte = (JasperReport) JRLoader
					.loadObject("bin/reportesnuevos/reporteProductosODTMenosVendidos.jasper");

			JasperPrint jasperPrint = JasperFillManager.fillReport(reporte,
					parameterMap, conn.getConexion());//
			JasperViewer jviewer = new JasperViewer(jasperPrint, false);
			jviewer.setTitle("Reporte Producto Elaborado menos vendido ODT");
