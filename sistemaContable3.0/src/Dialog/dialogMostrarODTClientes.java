...
public class dialogMostrarODTClientes extends JFrame {
	 ...
	 */
	public dialogMostrarODTClientes(String fecha1, String fecha2) {
		super();
		initialize();
	...
	public void llamarCompraporGastoReporte(String fecha1, String fecha2) {
		String Query = "SELECT "
				+ " distinct o.CI_RUC, count(o.CI_RUC),DESCRIPCION,o.FECHA,c.NOMBRE,sum(precio)"
				+ " FROM order_trabajo o,tipo_cliente t,cliente c "
				+ " where o.CI_RUC=c.CI_RUC" + " and o.fecha between '"
				+ fecha1 + "' and '" + fecha2 + "' " + " group by 1";
