...
public class dialogMostrar10MasVendidos extends JFrame {
	 ...
	 */
	public dialogMostrar10MasVendidos(String fecha1, String fecha2) {
		super();
		initialize();
	...
	public void llenarReporte(HashMap parameterMap, String Query) {
		...
		reporte = (JasperReport) JRLoader
					.loadObject("bin/reportesnuevos/reportProductoMasVendido.jasper");

			JasperPrint jasperPrint = JasperFillManager.fillReport(reporte,
					parameterMap, conn.getConexion());//
			JasperViewer jviewer = new JasperViewer(jasperPrint, false);
			jviewer.setTitle("Reporte producto mas vendido Recibos");
			...
			e.printStackTrace();
			error err=new error(""+e,"reportProductoMasVendido.jasper");
			err.setSize(460, 370);
			err.setVisible(true);
