...
public class dialogMostrarDocumentosAduana extends JFrame {
	 ...
	 */
	public dialogMostrarDocumentosAduana(String fecha1, String fecha2) {
		super();
		initialize();
	...
	public void llenarReporteEgresos(HashMap parameterMap, String Query) {
		...
		try {
			...
			reporte = (JasperReport) JRLoader
					.loadObject("bin/reportes/reporteDocumentosAduanaF.jasper");
