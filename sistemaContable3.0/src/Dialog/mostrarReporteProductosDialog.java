...
import reportes.ReporteProductoLlenarForm;
import ventanas.mostrarImagen;

public class mostrarReporteProductosDialog extends JFrame {
	 ...
	 */
	public mostrarReporteProductosDialog() {
		super();
		initialize();
	...
	private void verReporte() {
		ReporteProductoLlenarForm reporteJasper = new ReporteProductoLlenarForm();
		reporteJasper.recibirDatosExternos();
